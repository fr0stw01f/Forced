...
//	val HOOKING_LIBRARY = FrameworkOptions.frameworkDir + "/libs/zhook.jar"
	...
	val SOOT_OUTPUT_APK = UtilInstrumenter.SOOT_OUTPUT + File.separator + File(FrameworkOptions.getApkName()).name + ".apk"
	val SOOT_OUTPUT_DEPLOYED_APK = UtilInstrumenter.SOOT_OUTPUT + File.separator + File(FrameworkOptions.getApkName()).name + "_deployed.apk"
