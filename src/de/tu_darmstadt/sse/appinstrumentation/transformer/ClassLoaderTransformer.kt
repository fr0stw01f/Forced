...
class ClassLoaderTransformer : AbstractInstrumentationTransformer() {
    ...
    private val methodOwnLoader = Scene.v().getMethod(
            "<de.tu_darmstadt.sse.additionalappclasses.classloading.InterceptingClassLoader: " + "java.lang.Class loadClass(dalvik.system.DexFile,java.lang.String,java.lang.ClassLoader)>")
