...
object UtilInstrumenter {
    ...
    val ADDITIONAL_APP_CLASSES_BIN = FrameworkOptions.frameworkDir + "sootInstrument/android/"
    val SHARED_CLASSES_BIN = FrameworkOptions.frameworkDir + "sootInstrument/shared/"
