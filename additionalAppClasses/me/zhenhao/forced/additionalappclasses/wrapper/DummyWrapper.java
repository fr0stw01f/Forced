package me.zhenhao.forced.additionalappclasses.wrapper;
...
public class DummyWrapper {
	...
	public static Class<?> dummyWrapper_loadClass(String className, ClassLoader classLoader) {
		...
		try {
			...
			try {
				...
				try{
					clazz = classLoader.loadClass("me.zhenhao.forced.additionalappclasses.reflections.DummyReflectionClass");
	...
	public static Method dummyWrapper_getMethod(Class clazz, String methodName, Class[] parameterTypes) {
		...
		try{
			...
			try{
				Class dummyClass = Class.forName("me.zhenhao.forced.additionalappclasses.reflections.DummyReflectionClass");
