...
//		networkHooks.add(getHostAddress);
	...
	private Set<HookInfo> integrityRelatedHooks(){
		...
		MethodHookInfo integrity1 = new MethodHookInfo("<DummyWrapper: android.content.pm.PackageInfo dummyWrapper_getPackageInfo(android.content.pm.PackageManager,java.lang.String,int)>");
	...
	private Set<HookInfo> fileRelatedHooks() {
		...
		MethodHookInfo propertyString1 = new MethodHookInfo("<DummyWrapper: java.lang.String dummyWrapper_getProperty(java.util.Properties,java.lang.String)>");
		propertyString1.analysisDependentHookAfter();
		MethodHookInfo propertyString2 = new MethodHookInfo("<DummyWrapper: java.lang.String dummyWrapper_getProperty(java.util.Properties,java.lang.String,java.lang.String)>");
	...
	private Set<HookInfo> reflectionHooks() {
		...
		MethodHookInfo getMethodHookAfter = new MethodHookInfo("<DummyWrapper: java.lang.reflect.Method dummyWrapper_getMethod(java.lang.Class,java.lang.String,java.lang.Class[])>");
